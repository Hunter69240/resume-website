        ...
        <>
            <div className="w-[90%] max-w-screen-lg mx-auto bg-black text-white clip-polygon-custom p-4 flex mt-4 gap-4">
                ...
                <div className="flex flex-col justify-center text-white w-full">
                    <p className="text-white tracking-wide  mb-4 sm:text-3xl">
                    ...
                    <div className="w-full flex justify-end ">
                        <a 
                            ...
                            className="text-white border border-white hover:bg-white hover:text-black rounded-md px-4 py-1 mb-17 sm:text-2xl"
                        >
                            Download
                        </a>
                    </div>
